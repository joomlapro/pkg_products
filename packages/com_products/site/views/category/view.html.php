...
/**
 * HTML Category View class for the Products component.
 *
 * @package     Products
 * @subpackage  com_products
 * @since       3.0
...
class ProductsViewCategory extends JViewLegacy
{
	...
	protected function _prepareDocument()
	{
		...
		if ($menu && ($menu->query['option'] != 'com_products' || $menu->query['view'] == 'newsfeed' || $id != $this->category->id))
		{
			$path = array(array('title' => $this->category->title, 'link' => ''));
			$category = $this->category->getParent();

			while (($menu->query['option'] != 'com_products' || $menu->query['view'] == 'newsfeed' || $id != $category->id) && $category->id > 1)
			{

...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_products&task=activities.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'activityList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
<form action="<?php echo JRoute::_('index.php?option=com_products&view=activities'); ?>" method="post" name="adminForm" id="adminForm">
		...
		<table class="table table-striped" id="activityList">
			...
			<?php foreach ($this->items as $i => $item) :
				...
				<tr class="row<?php echo $i % 2; ?>">
					...
					<td class="nowrap">
						<?php if ($canEdit): ?>
							<a href="<?php echo JRoute::_('index.php?option=com_products&task=activity.edit&id=' . (int) $item->id); ?>"><?php echo $this->escape($item->name); ?></a>
						<?php else: ?>

...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_products&task=fields.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_products&view=fields'); ?>" method="post" name="adminForm" id="adminForm">
		...
		<table class="table table-striped" id="fieldList">
			<thead>
				<tr>
					...
					<th class="title">
						<?php echo JHtml::_('grid.sort', 'COM_PRODUCTS_HEADING_LABEL', 'a.label', $listDirn, $listOrder); ?>
					</th>
					<th width="20%" class="nowrap hidden-phone">
						<?php echo JHtml::_('grid.sort', 'COM_PRODUCTS_HEADING_TYPE', 'a.type', $listDirn, $listOrder); ?>
					</th>
					<th width="1%" class="nowrap center hidden-phone">
			...
			<?php foreach ($this->items as $i => $item) :
				...
				<tr class="row<?php echo $i % 2; ?>">
					...
					<td class="nowrap">
						...
						<?php endif; ?>
						<?php if ($canEdit): ?>
							<a href="<?php echo JRoute::_('index.php?option=com_products&task=field.edit&id=' . (int) $item->id); ?>"><?php echo $this->escape($item->label); ?></a>
						<?php else: ?>
							<?php echo $this->escape($item->name); ?>
						<?php endif; ?>
					</td>
					<td class="small nowrap hidden-phone">
						<?php echo JText::_('COM_PRODUCTS_OPTION_' . strtoupper($item->type)); ?>
					</td>
					<td class="center hidden-phone">

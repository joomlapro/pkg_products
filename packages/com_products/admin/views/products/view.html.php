...
class ProductsViewProducts extends JViewLegacy
{
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title(JText::_('COM_PRODUCTS_MANAGER_PRODUCTS'), 'products.png');

		if (count($user->getAuthorisedCategories('com_products', 'core.create')) > 0)
		{
		...
		JToolBarHelper::help('products', $com = true);
		...
		JHtmlSidebar::addFilter(
			...
			'filter_category_id',
			JHtml::_('select.options', JHtml::_('category.options', 'com_products'), 'value', 'text', $this->state->get('filter.category_id'))
		);
